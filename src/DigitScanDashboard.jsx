...
const styles = {
  app: { minHeight: '100vh', background: '#0f0f13', color: '#e8e8ec', fontFamily: FONT_SANS, fontSize: 14 },
  header: { display: 'flex', alignItems: 'center', gap: 24, padding: '12px 20px', borderBottom: '1px solid #232329', background: '#131318', flexWrap: 'wrap' },
  headerLeft: { display: 'flex', alignItems: 'center', gap: 10 },
  logoMark: { width: 32, height: 32, borderRadius: 6, background: '#3fb68a', color: '#0f0f13', fontFamily: FONT_MONO, fontWeight: 700, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 12 },
  appName: { fontWeight: 600, fontSize: 14, letterSpacing: 0.2 },
  feedStatus: { fontSize: 11, color: '#8f8f99', display: 'flex', alignItems: 'center', gap: 5 },
  dot: { width: 6, height: 6, borderRadius: '50%', display: 'inline-block' },
  tabs: { display: 'flex', gap: 4, marginLeft: 'auto', flexWrap: 'wrap' },
  tabBtn: { background: 'transparent', border: '1px solid transparent', color: '#8f8f99', padding: '6px 12px', borderRadius: 6, fontSize: 13, cursor: 'pointer', fontFamily: FONT_SANS },
  tabBtnActive: { background: '#1c1c22', color: '#e8e8ec', border: '1px solid #2c2c34' },
  headerRight: { marginLeft: 8 },
  acctPill: { fontFamily: FONT_MONO, fontSize: 11, background: '#1c1c22', border: '1px solid #2c2c34', padding: '5px 10px', borderRadius: 6, display: 'flex', alignItems: 'center', gap: 6 },
  acctPillMuted: { fontFamily: FONT_MONO, fontSize: 11, color: '#6a6a74', border: '1px solid #232329', padding: '5px 10px', borderRadius: 6 },

  body: { display: 'flex', minHeight: 'calc(100vh - 57px)' },
  sidebar: { width: 260, borderRight: '1px solid #232329', padding: 16, flexShrink: 0, background: '#111116' },
  sidebarSection: { marginBottom: 24 },
  sidebarLabel: { fontSize: 11, textTransform: 'uppercase', letterSpacing: 0.6, color: '#6a6a74', marginBottom: 8, fontWeight: 600 },
  select: { width: '100%', background: '#1a1a20', border: '1px solid #2c2c34', color: '#e8e8ec', padding: '8px 10px', borderRadius: 6, fontSize: 13, fontFamily: FONT_SANS },
  logPane: { display: 'flex', flexDirection: 'column', gap: 4, maxHeight: 400, overflowY: 'auto' },
  logLine: { fontSize: 11, fontFamily: FONT_MONO, lineHeight: 1.5, wordBreak: 'break-word' },
  logTime: { color: '#5a5a64' },
  logEmpty: { fontSize: 12, color: '#5a5a64' },

  main: { flex: 1, padding: 24, minWidth: 0 },
  viewHeader: { display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 20, flexWrap: 'wrap', gap: 12 },
  viewTitle: { fontSize: 20, fontWeight: 600 },
  viewSub: { fontSize: 12.5, color: '#8f8f99', marginTop: 2 },
  priceBlock: { textAlign: 'right' },
  priceLabel: { fontSize: 11, color: '#6a6a74', textTransform: 'uppercase', letterSpacing: 0.5 },
  priceValue: { fontFamily: FONT_MONO, fontSize: 22, fontWeight: 600, color: '#3fb68a' },

  statRow: { display: 'flex', gap: 12, marginBottom: 18, flexWrap: 'wrap' },
  statCard: { background: '#161619', border: '1px solid #232329', borderRadius: 8, padding: '12px 16px', flex: '1 1 140px', minWidth: 140 },
  statLabel: { fontSize: 11, color: '#8f8f99', marginBottom: 4 },
  statValue: { fontFamily: FONT_MONO, fontSize: 18, fontWeight: 600 },

  panel: { background: '#141418', border: '1px solid #232329', borderRadius: 10, padding: 20, marginBottom: 18 },
  panelTitle: { fontSize: 13, fontWeight: 600, marginBottom: 14, color: '#c8c8d0' },
  panelNote: { fontSize: 12, color: '#6a6a74', marginTop: 14, lineHeight: 1.5 },

  barsRow: { display: 'flex', gap: 8, alignItems: 'flex-end', height: 140 },
  barCol: { flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', height: '100%', justifyContent: 'flex-end' },
  barTrack: { width: '100%', flex: 1, display: 'flex', alignItems: 'flex-end', background: '#1a1a20', borderRadius: 4, overflow: 'hidden' },
  barFill: { width: '100%', borderRadius: '4px 4px 0 0', minHeight: 2, transition: 'height 0.3s ease' },
  barPct: { fontSize: 10.5, fontFamily: FONT_MONO, marginTop: 6 },
  barDigit: { fontSize: 12, fontFamily: FONT_MONO, color: '#8f8f99', marginTop: 2 },

  digitStrip: { display: 'flex', gap: 4, flexWrap: 'wrap' },
  digitChip: { width: 26, height: 26, borderRadius: 5, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: FONT_MONO, fontSize: 12, fontWeight: 700, color: '#0f0f13' },

  formGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 14, marginBottom: 16 },
  field: { display: 'flex', flexDirection: 'column', gap: 6 },
  fieldLabel: { fontSize: 11.5, color: '#8f8f99' },
  input: { background: '#1a1a20', border: '1px solid #2c2c34', color: '#e8e8ec', padding: '8px 10px', borderRadius: 6, fontSize: 13, fontFamily: FONT_MONO, width: '100%' },

  primaryBtn: { background: '#3fb68a', color: '#0f0f13', border: 'none', padding: '10px 20px', borderRadius: 7, fontSize: 13, fontWeight: 600, cursor: 'pointer', fontFamily: FONT_SANS },
  secondaryBtn: { background: 'transparent', color: '#a8a8b3', border: '1px solid #2c2c34', padding: '10px 20px', borderRadius: 7, fontSize: 13, cursor: 'pointer', fontFamily: FONT_SANS },
  btnRow: { display: 'flex', gap: 10, marginTop: 4 },

  chartWrap: { marginTop: 6, background: '#0f0f13', borderRadius: 6, border: '1px solid #1e1e24', padding: 8 },
  chartSvg: { width: '100%', height: 160, display: 'block' },

  checkboxRow: { display: 'flex', alignItems: 'center', gap: 8, fontSize: 12.5, color: '#a8a8b3', margin: '10px 0' },

  warnBanner: { background: '#2a1c14', border: '1px solid #4a3020', color: '#e8b04b', padding: '10px 14px', borderRadius: 8, fontSize: 12.5, marginBottom: 16 },

  acctDetail: { marginTop: 16, borderTop: '1px solid #232329', paddingTop: 16 },
  acctBadge: { display: 'inline-block', padding: '4px 10px', borderRadius: 5, fontSize: 11, fontWeight: 700, letterSpacing: 0.4, marginBottom: 12 },
  acctRow: { display: 'flex', justifyContent: 'space-between', fontSize: 13, padding: '6px 0', borderBottom: '1px solid #1c1c22', fontFamily: FONT_MONO },
};
